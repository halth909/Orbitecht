...
Scenarios = {
    ...
    linear = {
        name = "Linear",
        options = RoomGeneratorOptions.singleplayerPath,
        enemies = true
    },
    split = {
        name = "Split",
        options = RoomGeneratorOptions.singleplayerSplit,
        enemies = false,
    },
    arenaDefault = {
        name = "Arena Default",
        options = RoomGeneratorOptions.singleplayerDefault,
        enemies = true,
    },
    arenaSimple = {
        name = "Arena Simple",
        options = RoomGeneratorOptions.singleplayerSimple,
        enemies = true,
    },
    boss = {
        name = "Boss",
...
StateSingleplayer = {
    push = function()
        ...
        FloorCurrent.load(FloorGenerator.currentFloor)

        Minecarts.loadSingleplayer()
        Minecarts.onPortal = function(_, portalIndex)
            print("minecart portal singleplayer " .. portalIndex)
            return FloorCurrent.next(portalIndex)
        end

        Collectables.settings = CollectablesSettings.snake

        MusicPlayer.play()

        Input.pushSingleplayer()
